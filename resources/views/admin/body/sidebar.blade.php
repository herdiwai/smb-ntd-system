<nav class="sidebar">
    ...
    <div class="sidebar-body">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="uiComponents10">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="{{ route('personel.meetingroomlist') }}" id="notif-dropdown" class="nav-link">Booking List  <span id="notif-count" class="badge badge-danger"></span>
              </a>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="uiComponents12">
          <ul class="nav sub-menu">

            
            <li class="nav-item">
              <a href="{{ route('room.list') }}" class="nav-link">All Table</a>
            </li>
  
            <li class="nav-item">
              <a href="{{ route('add.meetingroom') }}" class="nav-link">Add Room Meeting</a>
            </li>
...
{{-- End Menu Camera Monitoring Record --}}
    ...
    {{-- End Menu MRR for NTD user --}}
        ...
        @if(Auth::user()->can('process.menu'))
          ...
          @if(Auth::user()->can('equipment.menu'))
          <li class="nav-item">
