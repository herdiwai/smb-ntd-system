            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="exampleFormControlSelect4" name="lot">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="exampleFormControlSelect5" name="lot">
                    ...
                    <div class="input-group flatpickr" id="flatpickr-time">
                        <input type="time" name="time" class="form-control @error('time') is-invalid @enderror" placeholder="Select time" data-input>
                        ...
                        <h6 class="card-title">DATE</h6><div class="input-group flatpickr" id="flatpickr-date">
                            <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" placeholder="Select date" data-input>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="target" class="form-control @error('target') is-invalid @enderror" id="exampleInputText1">
                        @error('target')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="output" class="form-control @error('output') is-invalid @enderror" id="exampleInputText1">
                        @error('output')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="accm" class="form-control @error('accm') is-invalid @enderror" id="exampleInputText1">
                        @error('accm')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="deskription" id="exampleFormControlTextarea1" rows="5"></textarea>
                    </div>
